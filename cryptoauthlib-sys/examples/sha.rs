...
use cryptoauthlib_sys::{
    atca_command, atca_device, atca_iface, calib_get_zone_size, calib_info,
...
fn main() -> ! {
    ...
    assert_eq!(&[0x00, 0x00, 0x60, 0x02], revision_buf);
    ...
    assert_eq!(
        &[0x01, 0x23, 0x14, 0x16, 0x39, 0xcd, 0xd1, 0xc1, 0xee],
        sn_buf
    );
